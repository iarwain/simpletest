...
ifeq ($(config),debug64)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../lib/linux64 -L. -m64 -L/usr/lib64 -Wl,-rpath ./ -Wl,--export-dynamic
...
ifeq ($(config),debug32)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../lib/linux32 -L. -m32 -L/usr/lib32 -Wl,-rpath ./ -Wl,--export-dynamic
  LIBS      += -lorxd -ldl -lm -lrt
  LDDEPS    +=
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
...
$(OBJDIR)/simpletest.o: ../../../src/simpletest.c
	@echo $(notdir $<)
